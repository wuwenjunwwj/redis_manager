...
ACLOCAL = ${SHELL} /search/wuwenjun/project/redis_manager/_aux/missing --run aclocal-1.11
AMTAR = ${SHELL} /search/wuwenjun/project/redis_manager/_aux/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /search/wuwenjun/project/redis_manager/_aux/missing --run autoconf
AUTOHEADER = ${SHELL} /search/wuwenjun/project/redis_manager/_aux/missing --run autoheader
AUTOMAKE = ${SHELL} /search/wuwenjun/project/redis_manager/_aux/missing --run automake-1.11
AWK = gawk
BUILD_DEPENDENCIES = /search/wuwenjun/project/redis_manager
CC = gcc -std=gnu99
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /search/wuwenjun/project/redis_manager/_aux/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
OBJDUMP = objdump
...
STRIP = strip
VERSION = 2.0.0
abs_builddir = /search/wuwenjun/project/redis_manager
abs_srcdir = /search/wuwenjun/project/redis_manager
abs_top_builddir = /search/wuwenjun/project/redis_manager
abs_top_srcdir = /search/wuwenjun/project/redis_manager
...
install_sh = ${SHELL} /search/wuwenjun/project/redis_manager/_aux/install-sh
